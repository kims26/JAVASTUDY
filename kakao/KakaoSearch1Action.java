...
import util.KakaoSearch1Utils;
import vo.Location1Vo;

/**
 * Servlet implementation class KakaoSearchAction
 */
@WebServlet("/kakao/keyword.do")
public class KakaoSearch1Action extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		List<Location1Vo> list = KakaoSearch1Utils.searchKeyword(query,latitude, longitude, 1, 10);
...
//		}
		...
		//Dispatcher
		String forward_page = "kakao_keyword_list3.jsp";
