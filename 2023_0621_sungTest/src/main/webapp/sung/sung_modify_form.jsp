...
<script type="text/javascript">
  ...
  function send(f){
	  ...
	  if(confirm("정말수정하시겠습니까?")==false){
		  ...
		  //취소눌렀을때
		  location.href='';//자신의 페이지 호출=> 원래(수정전)데이터 출력
		  return;
	  }
...
<form>
	...
	<div id="box">
		<div class="panel panel-primary">
	      <div class="panel-heading"><h4>성적수정폼</h4></div>
	      <div class="panel-body">
	         <table class="table">
	             ...
	             <tr>
	                <th>국어</th>
	                <td><input class="form-control" name="kor" value="${ vo.kor }"></td>
	             </tr>
	             
	             <tr>
	                <th>영어</th>
	                <td><input class="form-control"  name="eng" value="${ vo.eng }"></td>
	             </tr>
	              
	             <tr>
	                <th>수학</th>
	                <td><input class="form-control" name="mat" value="${ vo.mat }"></td>
	             </tr>
