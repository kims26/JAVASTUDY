...
import vo.MemberVo;
	...
	public class MemberModifyAction extends HttpServlet {
		...
		protected void service(HttpServletRequest request, HttpServletResponse response)
			...
			String mem_zipcode  = request.getParameter("mem_zipcode").replaceAll("\n", "<br>");
			...
			MemberVo vo =new MemberVo(mem_idx,mem_name,mem_id,mem_pwd,mem_zipcode,mem_addr,mem_grade,mem_ip);
